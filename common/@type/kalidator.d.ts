...
declare module '@owneul/kalidator' {
    class Kalidator {
        ...
        setRules(rules: { [paramName: string]: string[] }): Kalidator

        setMessages(messages: { [targetName: string]: string }): Kalidator

        registTester(testerName: string, tester: (param: string, extraValue:string, data:Object) => boolean): Kalidator
