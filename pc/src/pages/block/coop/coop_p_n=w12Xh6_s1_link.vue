<template>
    <MMBlock
        :block-name="'coop_p_n=w12Xh6_s1_link'"
        :required="{
            requiredValueList: [block.title1, block.title2, jointPurchase],
        }"
    >
        <MMTitle 
            :title1="block.title1"
...
<style>
    @import "@publish/css/block/specific/coop_p_n=w12Xh6_s1_link.css";
</style>