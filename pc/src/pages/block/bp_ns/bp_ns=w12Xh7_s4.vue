<template>
    <MMBlock
        :block-name="'bp_ns=w12Xh7_s4'"
        :required="{
            requiredValueList: [ block.bannerPartition?.banners, banner?.goodsGroup?.goodsList, block.title1, block.title2 ]
        }"
    >
        <MMTitle 
            :title1="block.title1"
...
<style>
@import '@publish/css/block/normal/bp_ns=w12Xh7_s4.css';
</style>
