<template>
    <MMBlock
        :block-name="'bp_ns=w12Xh8_s5_link'"
        :required="{
    ...
    >
        ...
        <div class="mui_inner">
            ...
            <div class="mui_product-list">
                ...
                >
                    <template #item="{ item }">
                        <MMBlockGoods :goods="item" :is-show-price="false" :use-liked-button="true" />
                    </template>
                </MMSlider>
            </div>
            <!--// 상품 -->
...
<style>
@import '@publish/css/block/normal/bp_ns=w12Xh8_s5_link.css';
</style>
