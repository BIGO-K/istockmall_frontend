<template>
    <MMBlock
        :block-name="'mult_p_n=w12Xh14_s10_refresh'"
        :required="{
            requiredValueList: [block.title1, block.title2, goodsList],
        }"
    >
        <MMTitle 
            :title1="block.title1"
...
<style>
@import '@publish/css/block/specific/mult_p_n=w12Xh14_s10_refresh.css';
</style>
