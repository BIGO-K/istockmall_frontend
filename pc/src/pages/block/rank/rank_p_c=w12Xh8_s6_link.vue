<template>
    <MMBlock
        :block-name="'rank_p_c=w12Xh8_s6_link'"
        :required="{
    ...
    >
        ...
        <div class="m_ranking">
            <div v-if="activeGoods" class="m_ranking-active-item">
                <MMRankingGoods :goods="activeGoods" :has-range="block.rankHasRange"/>
...
<style>
@import '@publish/css/block/specific/rank_p_c=w12Xh8_s6_link.css';
