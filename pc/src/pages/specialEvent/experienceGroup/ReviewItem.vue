<template v-if="experienceGroup">
    ...
    <div>
        ...
        <span class="text_view">
            조회<strong>{{ MMFilters.formatNumber(experienceGroup.viewCount) }}</strong>
        </span>
        <span class="text_date">{{ MMFilters.formatDate(experienceGroup.createdAt, 'YYYY.MM.DD') }}</span>
    </div>
</template>
