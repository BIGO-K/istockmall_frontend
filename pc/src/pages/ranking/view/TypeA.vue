<template>
            ...
            >
                <template #additionalItem>
                    <li class="mm_slider-item">
                        <button
                            ...
                            type="button"
                            @click="fetchRankingView(selectedRankRange, '')"
                        >
                ...
                <template #item="{ item }">
                    <button 
                        ...
                        type="button"
                        @click="fetchRankingView(selectedRankRange, item.code)"
                    >
                        <i
    ...
    <template v-if="rankingItem !== null && rankingItem.goodsList">
        <div class="mm_inner m_ranking-view">
            ...
            <!-- VIEW 랭킹 상품 -->
            <div
                v-if="rankingItem.goodsList.length > 0"
...
import { useViewRanking } from '$/composables/rankingComposable';
