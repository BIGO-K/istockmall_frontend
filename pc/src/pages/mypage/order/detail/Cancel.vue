            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text_point">
                                <strong>{{ MMFilters.formatNumber(cancelDetail.refundInfo.refundPoint) }}</strong>
                                <sub>원</sub>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p class="text_price mm_text-variable">
                                <strong>{{ MMFilters.formatNumber(cancelDetail.refundInfo.refundPoint + cancelDetail.refundInfo.refundPrice) }}</strong>
                            </p>
                        </td>
                    </tr>
                </tbody>
