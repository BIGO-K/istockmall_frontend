                            ...
                            <td>
                                <div class="mm_form_mix-address">
                                    ...
                                    <div class="mm_form-text">
                                        ...
                                        <label>
                                            <input
                                                v-model="receiverForm.baseAddress"
                                                type="text"
                                                class="textfield"
                                                data-text
                                                readonly
                                    ...
                                    <ul>
                                        <li>
                                            <label class="mm_form-radio">
                                                <input
                                                    v-model="receiverForm.message"
                                                    type="radio"
                                                    name="shipping_message"
                                                    data-radio
                                                    :checked="receiverForm.message=== ''"
                                                    @change="() => { receiverForm.message = '' }"
                                                >
                                                <b class="mm_block">
                                        ...
                                        <li v-for="message in shippingMessages" :key="message">
                                            <label class="mm_form-radio">
                                                <input
                                                    ...
                                                    name="shipping_message"
                                                    data-radio
                                                    :checked="receiverForm.message === message"
                                                    @change="() => { receiverForm.message = message }"
                                                >
                                                <b class="mm_block">
                                                    <i class="ico_form-radio" />
                                        ...
                                        <li>
                                            <div class="mm_form_mix-linked">
                                                ...
                                                <MMInput 
                                                    ...
                                                    :disabled="receiverForm.message !== '직접 입력'"
                                                    maxlength="20"
                                                /> 
                                            </div>
                                        </li>
                            ...
                            <td>
                                ...
                                <div class="mm_note">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        title="새 창 열림"
                                    ><b>개인통관고유부호 발급/확인 바로가기</b><i class="ico_link" /></a>
                                </div>
                        ...
                        <div class="mm_order...seller-head">
                            <p class="text_ship">
                                ...
                                <span
                                    v-else
                                    class="text_price"
                                ><strong>{{ MMFilters.formatNumber(receiverForm.isExtraArea ? (pack.chargedShippingPrice + pack.extraShippingPrice) : pack.chargedShippingPrice) }}</strong></span>
                            </p>
                        </div>
                        <ul>
                            <li v-for="item in pack.groupOrders" :key="item.goodsId">
                                <div class="mm_flex">
                                        ...
                                        <MMLink :to="{ name: 'GoodsDetail', params: { id: item.goodsId }}">
                                            <figure>
                                                ...
                                                <figcaption>
                                                    ...
                                                    <p class="text_option">
                                                        {{ item.optionName.replace('/', '') }}/{{ item.items.length }}개
                                                    </p>
                                                </figcaption>
                                            </figure>
                                        </MMLink>
                                    ...
                                    <p class="text_price">
                                        <strong>{{ MMFilters.formatNumber(item.packGoodsSellPrice) }}</strong>
                                    </p>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="m_order-payment">
                <div>
                    ...
                    <section class="m_order-payment-method">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <MMSelect 
                                                    v-model.number="paymentForm.cardCode" 
                                                    class="T=short"
                                                >
                                                    <option value="0">
                                                        카드를 선택하세요
                        ...
                        <!-- 무통장 입금 -->
                        <div :class="['mm_syncer-method-account m...method-account', { 'S=radio-use' : paymentForm.payMethodEngLabel === 'virtual_account' }]">
                            <div class="mm_order-form">
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <MMSelect
                                                    v-model.number="paymentForm.bankCode"
                                                    class="T=short"
                                                >
                                                    <option value="0">
                                                        은행을 선택하세요
                                                ...
                                                <div class="mm_radio-list">
                                                    <ul>
                                                        <li>
                                                            <label class="mm_form-radio">
                                                                <input
                                                                    v-model="paymentForm.cashReceiptApplyType"
                                                                    type="radio"
                                                                    value="1"
                                                                    name="cach_receipt"
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <MMSelect
                                                    v-model="refundAccount.bankCode"
                                                    class="T=short"
                                                >
                                                    <option value="">
                                                        은행을 선택하세요
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    ...
                                    <li :class="{'S=switch-on': offerSwitchOn }">
                                        <b>개인정보 제 3자 제공 동의</b>
                                        <button
                                            type="button"
                                            class="btn_detail"
                                            data-switch="{ '_isParent': true }"
                                            @click="() => { offerSwitchOn = !offerSwitchOn }"
                                        >
                                            <b>자세히</b>
                                        </button>
                                        <!-- 개인정보 제 3자 제공 동의 -->
...
import { Pack, PayMethod, OrderPrePareForm, PaymentForm } from '$/@type/order/order';
...
function postCodeModalOpen() {
    useModal().open(PostCode, {
        title: '우편번호 찾기',
        name: 'PostCode',
        onClose: async(address: { 
            zipCode: string, 
            road: string
        }) => {
            receiverForm.value.zipCode = address.zipCode;
            receiverForm.value.baseAddress = address.road;
            receiverForm.value.isExtraArea = await shippingRepository.isExtraAreaCheck(address.zipCode, address.road);
        }
    })
}
