<template>
    <div ref="sliderElement" class="mui_slider" data-slider="{ '_isLoop': false }">
...
import { sliderReload, sliderUpdate } from '@/customMotion'
import { toRefs, onMounted, ref, computed, watch, onBeforeUnmount } from 'vue'
