            ...
            >
                ...
                <figure>
                    ...
                    <figcaption>
                        ...
                        >
                            <p
                                v-if="goods.reviewScoreAverage && goods.reviewScoreAverage > 0"
                                class="text_star"
                            >
                                <i class="ico_star" /><span>{{ goods.reviewScoreAverage }}</span>
                            </p>
                            <p
                                v-if="goods.reviewCount && goods.reviewCount > 0"
                                class="text_review"
                            >
                                <i class="ico_review" /><span>{{ goods.reviewCount }}</span>
                            </p>
                            <p
                                v-if="goods.wishCount && goods.wishCount > 0"
                                class="text_like"
                            >
            ...
            >
                ...
                <figure>
                    ...
                    <figcaption>
                        ...
                        <div
                            v-if="approachSoldout || displayedBadges.length > 0"
                            class="mm_tag-list"
                        >
                            <b v-if="approachSoldout" class="mm_tag T=product-status">품절임박</b>
                            <b
