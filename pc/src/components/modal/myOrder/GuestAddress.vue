...
const props = defineProps<{
    closer: ModalCloseHandler<Omit<ShippingAddress, "id"|"shippingName">>,
}>();


/** VARIABLE */
const receiveAddress = ref<Omit<ShippingAddress, "id"|"shippingName">>({
    zipCode: '',
    name: '',
    tel: '',
    baseAddress: '',
...
async function updateAddress() {
    ...
    try {
        await validator.run();
        props.closer(receiveAddress.value);
    } catch (e) {
        console.log(e); 
        defaultCatch(e);
    }
