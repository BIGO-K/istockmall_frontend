...
mm.pageEvent = (function () {
	...
	var base = {
		...
		init: function () {
			...
			mm.intersection.on($reply, function (__entry, __is) {

				gsap.to(mm.find('.mm_event-anchor-inner', $anchor), { duration: 0.2, translateY: (__is) ? '-100%' : 0 });
