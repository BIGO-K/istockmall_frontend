...
mm.ready(function () {
	...
	_.forEach(mm.find('.m_prodetail-frame-info'), function (__$el) {
		...
		_.forEach(mm.find('iframe'), function(__$iframe) {
			...
			if (__$iframe.getAttribute('src').includes('youtube') && !__$iframe.parentElement.classList.contains('m...info-media')) {
				mm.element.wrap(__$iframe, 'div');
				__$iframe.parentElement.classList.add('m...info-media');
			}
