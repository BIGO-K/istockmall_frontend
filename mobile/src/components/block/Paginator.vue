...
const { pageBlockType, pageBlockCount, currentPage, itemsPerPage, totalCount, scrollYTarget } =
            toRefs(props);
...
function scrollTop() {
    mmon.scroll.to(scrollYTarget.value || document.querySelector('#app') as Element, {
        margin: 0,
        time: 0.0
    });   
}
