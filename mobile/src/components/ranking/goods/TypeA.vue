            ...
            >
                ...
                <figure>
                    ...
                    <figcaption>
                        ...
                        <div v-if="goods.badges?.length" class="mm_tag-list">
                            <b v-for="badge in goods.badges" :key="badge" class="mm_tag">{{ badge }}</b>
                        </div>
                        <p v-if="isShowWishCount && goods.wishCount !== undefined && goods.wishCount > 0" class="text_like">
...
export default defineComponent({
    ...
    props: {
        goods: {
            type: Object as PropType<RankingGoods>,
            required: true
        },
        isShowPrice: {
            type: Boolean,
