<template>
    <MMBlock
        block-name="rank_p_n=w6Xh18_s5_link_1"
        :required="{
    ...
    >
        ...
        <div class="mui_product-list">
            <ol>
                <li v-for="(goods, goodsIndex) in block.goodsGroup?.goodsList" :key="goods.id">
...
<style>
@import '@publish/css/block/feature/rank_p_n=w6Xh18_s5_link_1.css';
</style>
