<template>
    <MMBlock
        :block-name="'rank_p_n=w6Xh19_s5_link'"
        :required="{
                        ...
                        <MMRankingGoods :goods="goods">
                            ...
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <p v-if="goods.saleRate > 0" class="text_sale">
                                        {{ goods.saleRate }}%
                                    </p>
                                    <p class="text_price">
                                        <strong>{{ MMFilters.formatNumber(goods.baseDiscountedPrice) }}</strong>
                                    </p>
                                    <ul v-if="goods.badges?.length || (goods.stock && goods.stock < 6)">
...
<style>
@import '@publish/css/block/feature/rank_p_n=w6Xh19_s5_link.css';
</style>