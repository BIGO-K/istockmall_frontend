                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p class="text_price">
                                        <strong>
                                            {{ MMFilters.formatNumber(returnDetail.refundInfo.totalPaidPrice + returnDetail.refundInfo.refundPoint) }}
                                        </strong>
                                    </p>
                                </td>
                            </tr>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text_point">
                                        <strong>{{ MMFilters.formatNumber(returnDetail.refundInfo.refundPoint) }}</strong>
                                        <sub>원</sub>
                                    </p>
                                </td>
                            </tr>
