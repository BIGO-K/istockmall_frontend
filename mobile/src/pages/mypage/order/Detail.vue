                                    ...
                                    <div class="mm_dropdown-item-inner">
                                        <div class="mm_inner">
                                            <div class="mm_order-info">
                                                ...
                                                <a v-if="order.shippingAddressChangeable" class="mm_btn T=xs T=line btn_address-change" href="#ADDRESS_LIST"><b>주소변경</b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <div class="mm_btn_box">
                                                                            <div class="mm_flex T=equal">
                                                                                ...
                                                                                <a 
                                                                                    ...
                                                                                    @click="setPurchaseConfirmModalData(orderItem, seller.name)"
                                                                                ><b>구매확정</b>
                                                                                </a>
                                                                                <button 
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr v-if="order.paymentSummary.usedPoints > 0">
                                                                ...
                                                                <td>
                                                                    <p class="text_point">
                                                                        - <strong>{{ MMFilters.formatNumber(order.paymentSummary.usedPoints) }}</strong><sub>원</sub>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p class="text_point">
                                                                    <strong>{{ MMFilters.formatNumber(order.paymentInfo.buyPoint - order.paymentInfo.exceptBuyPoint) }}</strong><sub>원</sub>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
...
import { usePurchaseConfirm, useReceiptModal, useShippingAddressEdit } from '$/composables/mypage/order/myOrderComposable';
...
// 배송지(반품수거지) 변경 기능
const { clearShippingAddressEditModal } = useShippingAddressEdit(async (newVal) => {
    if (!newVal) {
        return;
    }
    try {
        await myOrderRepository.updateDeliveryAddressId(order.value.orderId, newVal.id);
