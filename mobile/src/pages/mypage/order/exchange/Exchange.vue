                                            ...
                                            <li v-for="(retrieveMethod, index) in availableRetrieveMethods" :key="retrieveMethod.code">
                                                ...
                                                <div v-else-if="!isRetrievedByOrderer && exchangeForm.retrieveMethod == retrieveMethod.code" class="mm_syncer-way-yet S=radio-use">
                                                    <div class="mm_order-info">
                                                        ...
                                                        <a class="mm_btn T=xs T=line btn_address-change" href="#ADDRESS_LIST" @click.capture="isEditingRetrieveAddress = true;"><b>주소변경</b></a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <div class="mm_process-item" :class="process.exchangeAddress ? 'S=process-on' : ''">
                                <div class="mm_inner">
                                    ...
                                    <div class="mm_order-info">
                                        ...
                                        <a class="mm_btn T=xs T=line btn_address-change" href="#ADDRESS_LIST" @click.capture="isEditingExchangeAddress = true;"><b>주소변경</b></a>
                                    </div>
                                    <div class="mm_foot">
                                        <div class="mm_btn_box">
                                            <div class="mm_flex T=auto">
...
import { RetrieveMethod, ExchangeAdditionalPaymentPrice, ExchangeOrderItemSelectForm, ExchangePaymentForm, ExchangeForm, ExchangeOptionPair } from '$/@type/myOrder';
