...
import { useOrderItemSelectModal, useSelectedOrderItems } from '$/composables/mypage/order/orderItemSelectComposable';
...
onMounted(() => {
    ...
    selected.value = getPartialSelectedItems(orderItemSetId.value);
});
...
function applySelected() {
    ...
    setSelectedOrderItemIds(orderItemSetId.value, selected.value);
